  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-[#e6b400] to-[#d6a700] p-6 md:p-8">
          ...
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <button 
                ...
                className="text-[#e6b400] font-medium hover:underline"
              >
              ...
              <div className="space-y-5">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 ${
                      errors.name
                        ...
                        : "border-gray-300 focus:ring-[#e6b400]/20 focus:border-[#e6b400]"
                    }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 border-gray-300 focus:ring-[#e6b400]/20 focus:border-[#e6b400]"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 appearance-none bg-white border-gray-300 focus:ring-[#e6b400]/20 focus:border-[#e6b400]"
                    style={{
                      backgroundImage:
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="4"
                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#e6b400]/20 focus:border-[#e6b400] border-gray-300"
                ...
                {/* Submit Button */}
                <div>
                  <Button type="submit" color="yellow" className="w-full group">
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                  ...
                  <a href="/privacy-policy" className="text-[#e6b400] hover:underline">
                    Privacy Policy
                  </a>
